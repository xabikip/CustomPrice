...
class Customprice extends Module
{
	...
	public function getContent()
	{
	    ...
	    if (Tools::isSubmit('submit'.$this->name))
	    {
	        ...
	        $precio_carac_num = strval(Tools::getValue('precio_carac_num'));
	        ...
	        if (!$precio_carac_nombre  || empty($precio_carac_nombre) || !Validate::isGenericName($precio_carac_nombre) and
	        	!$precio_carac_num  || empty($precio_carac_num) || !Validate::isGenericName($precio_carac_num) and
	        ...
	        else
	        {
	            ...
	            Configuration::updateValue('precio_carac_num', $precio_carac_num);
	...
	public function displayForm()
	{
	    ...
	    $helper->fields_value['precio_carac_num'] = Configuration::get('precio_carac_num');
	...
	public function hookdisplayRightColumnProduct($params){
        ...
        $this->context->smarty->assign(
	        array(
	            ...
	            'precio_carac_num' => Configuration::get('precio_carac_num'),
